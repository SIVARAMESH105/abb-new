...
class CreditSuccessEmail implements ShouldQueue
{
    ...
    public function handle()  
    {
        ...
        $data['amount'] = $this->data['amount'].'.00';
        $admin_mail= ENV('ADMIN_EMAIL','mike@newtechweb.com');
        $subject = 'Refund Transaction!';
        //Email to admin
        Mail::send('emailTemplates.userRefundEmail', $data, function($message) use ($admin_mail,$subject) {
    ...
    {
        $logObj = new Logger('Refund camp registration');
