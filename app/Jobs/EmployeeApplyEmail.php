...
class EmployeeApplyEmail implements ShouldQueue
{
     ...
     * @return void
     */
    public function __construct($empApply)
    { 
        $this->data = $empApply;
    ...
    {  
        ...
        $subject = 'Advantage Basketball Employment Application Submission';
        Mail::send('Site.employ_app_email', $values, function($message) use ($userEmailId,$admin_mail,$subject) {
    ...
    public function failed($exception)
    {
        ...
        $LogObj = new Logger('EmployeeApplyEmail');
