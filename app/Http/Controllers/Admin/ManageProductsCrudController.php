...
class ManageProductsCrudController extends CrudController
{
    ...
    public function setUp()
    {
        ...
        */
		...
		$this->crud->addFields([
                                    ...
                                    [
                                        'name'  => 'pd_weight',
                                        'label' => 'Product Weight (In Pounds)<span class="red">*</span>',
                                        'type'  => 'text',
                                    ],
									[
										'name'  => 'pd_image',
    ...
    {	$main_img_ext = pathinfo($request->pd_image->getClientOriginalName(), PATHINFO_EXTENSION);
		...
		if($main_img_ext == 'jpg' || $main_img_ext == 'png' || $main_img_ext == 'jpeg' || $main_img_ext == 'gif' && $thum_img_ext == 'jpg' || $thum_img_ext == 'png' || $thum_img_ext == 'jpeg' || $thum_img_ext == 'gif'){
