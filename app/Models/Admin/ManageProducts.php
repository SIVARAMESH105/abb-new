...
class ManageProducts extends Model
{
    ...
    */
    ...
    protected $fillable = [ 'pd_id', 'pd_name', 'pd_thumbnail','pd_category', 'pd_shorttitle', 'pd_description','pd_price','pd_color','pd_size','pd_specialprice','pd_breakqty','pd_qty','pd_image','pd_staff','pd_status','pd_date','pd_weight'];
