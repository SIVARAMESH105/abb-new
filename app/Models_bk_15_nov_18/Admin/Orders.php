...
class Orders extends Model {
	...
	*/
	...
	{
		$updateStatus = DB::table('tbl_order')->where('od_id', $orderId)->update(['od_status' => $status, 'od_last_update' => Carbon::now()]);
	}
