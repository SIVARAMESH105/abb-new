...
class OrderOneOnOne extends Model
{
	...
	public function updateSubcriptionDate($subscriptionId)
	{
		DB::table($this->table)->where('subscription_id', $subscriptionId)->update(array('last_recurring_date' => date('Y-m-d')));
	}
}
