...
class Users extends Model
{
	...
	public function getCampDetails(){
		...
		$campDetails = DB::table('tbl_roster as r')
            ...
            ->select('r.id','r.last_update','c.id as c_id','c.camp_focus','c.startdate','c.enddate','c.starttime','c.endtime','c.cost','c.contact','l.Location','l.Address','l.City','Co.country_name')
	...
	public function getOrderProductDetails($user_id){
		...
		$productDetails = DB::table('tbl_order as or')
            ...
            ->select('or.od_id','or.od_wa_cost','or.user_id','oi.pd_id','oi.od_qty','oi.od_size','oi.od_color','p.pd_name','p.pd_category','p.pd_thumbnail','p.pd_price')
