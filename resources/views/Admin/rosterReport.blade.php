...
@section('header')
	<section class="content-header">
	  	<h1>
		    <span class="text-capitalize">Roster Report</span>
	  	</h1>
	  	<ol class="breadcrumb">
		    <li><a href="{{ url(config('backpack.base.route_prefix'), 'dashboard') }}">{{ trans('backpack::crud.admin') }}</a></li>
		    <li class="active">Roster Report</li>
	  	</ol>
	</section>
@endsection
@section('content')
	    ...
	    <div class="col-md-12">
			<div class="box">
				...
				<div class="box-body table-responsive">
					<table id="rosterReportTable" class="table table-bordered table-striped display">
						<thead>
							<tr>
								<th>Camp Name</th>
								<th>Location</th>
...
@section('after_scripts')
	...
	<script type="text/javascript">
		$(document).ready(function() {
		    ...
		    var table = $('#rosterReportTable').DataTable({
		        ...
		        serverSide: false,
				ajax: {
		            "url": base_url+"/admin/rosterReportTable",
		        ...
		        columns: [
		            ...
		            { data: 'camprevenue', name: 'camprevenue'},
