								...
								<td colspan="3" width="600" align="center">
									<div class="contentEditableContainer contentTextEditable">
					                	<div class="contentEditable" align='left' >
					                  		<p >Hi @if(isset($directorDetails['name'])) {{ $directorDetails['name'] }} @endif,
					                  			<br/>
					                  			<br/>
												</p>
					                	</div>
					              	</div>
									<p>You are now director of  advantage basketabll. Please use this below details for your login and we request you to change your password after your first login.</p>
									<p>Name : @if(isset($directorDetails['name'])) {{ $directorDetails['name'] }} @endif</p>
									<p>Email : @if(isset($directorDetails['email'])) {{ $directorDetails['email'] }} @endif</p>
									<p>Password : @if(isset($directorDetails['password'])) {{ $directorDetails['password'] }} @endif</p>

									<p>To login, please click the button below.</p>

									<p><a href="{{ url('admin/login') }}">Advantage basketball Director Login</a></p>
