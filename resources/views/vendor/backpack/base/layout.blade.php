...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('public/css/style_custom.css') }}">
...
<body class="hold-transition {{ config('backpack.base.skin') }} sidebar-mini">
    ...
    <script type="text/javascript">
        function statusCheck(id){           
            if ($('#video_status_'+id).prop('checked') == true) {
                videostatus = 1;                
            } else if ($('#video_status_'+id).prop('checked') == false) {
                videostatus = 0;
            }   
            $.ajax({
                url: './video/activestatus/'+id+'/'+videostatus,
                type: "POST",
    ...
    <script type="text/javascript">
        function imageStatus(id){           
            if ($('#imagestatus'+id).prop('checked') == true) {
                imagestatus = 1;                
            } else if ($('#imagestatus'+id).prop('checked') == false) {
                imagestatus = 0;
            }   
            $.ajax({
                url: './image/activestatus/'+id+'/'+imagestatus,
                type: "POST",
                data:'_token = <?php echo csrf_token() ?>',
                dataType: "json",                      
            });         
