...
@if ($crud->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    <link rel="stylesheet" href="{{ asset('public/vendor/adminlte/plugins/daterangepicker/daterangepicker.css') }}">
    @endpush

    {{-- FIELD JS - will be loaded in the after_scripts section --}}
    @push('crud_fields_scripts')
    <script src="{{ asset('public/vendor/adminlte/plugins/daterangepicker/moment.min.js') }}"></script>
    <script src="{{ asset('public/vendor/adminlte/plugins/daterangepicker/daterangepicker.js') }}"></script>
    <script>
